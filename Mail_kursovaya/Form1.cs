...
namespace Mail_kursovaya
{
    public partial class Form1 : Form
    {
        ...
        class inbox_class
        {
            ...
            public inbox_class()
            { }
            public inbox_class(CourseDB.inboxRow letter)
            {
        ...
        class outbox_class
        {
            ...
            public outbox_class(){ }
            public outbox_class(CourseDB.outboxRow letter)
            {
        ...
        ************************************************************/
        ...
        private void OpenPortsButton_Click(object sender, EventArgs e)
        {
            ...
            this.OpenPortsButton.Enabled = false;
            this.ClosePortsButton.Enabled = true;
        ...
        ***************************************************************************/
        ...
        //Закрытие портов
        private void ClosePortsButton_Click(object sender, EventArgs e)
        {
            if (serialPort1.IsOpen)
            {
                try
